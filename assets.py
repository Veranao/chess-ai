...
def draw_board(screen, width, height, turn_step, big_font):
    for i in range(32):
        row = i // 4
        column = i % 4
...
def draw_pieces(piece_list, white_pieces, black_pieces, white_images, black_images, white_locations, black_locations, screen):
